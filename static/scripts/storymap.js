$(window).on('load', function() {
  ...
  $.get('static/csv/Options.csv', function(options) {

    $.get('static/csv/Chapters.csv', function(chapters) {
      initMap(
  ...
  */
  ...
  function changeAttribution() {
    ...
    var credit = 'View <a href="'
      ...
      + (typeof googleDocURL !== 'undefined' && googleDocURL ? googleDocURL : 'static/csv/Chapters.csv')
